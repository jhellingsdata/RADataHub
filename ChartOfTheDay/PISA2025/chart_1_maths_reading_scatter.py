...
SOURCE_FILE = ("/Users/alonso/Documents/GitHub/RADataHub/ChartOfTheDay/"
               "PISA2025/mrq53f.xlsx")
...
chart = (
    ...
    .properties(
        ...
        title=alt.TitleParams(
            "UK 15-year-olds outscore the OECD average in both maths and reading",
            subtitle=[
